...
class TestMovingPandasAnalyzer(TestCase):
    ...
    def test_it_should_handle_empty_input(self):
        ...
        # verify
        self.assertEqual(actual['n'], "empty-result")
    ...
    def test_it_should_analyze_input4_LatLon(self):
        ...
        self.assertEqual(actual['projection'], 'EPSG:4326')
        self.assertEqual(actual['positions_bounding_box'], {'x_min': 3.7317, 'y_min': 49.417633, 'x_max': 53.619633, 'y_max': 69.156667})
